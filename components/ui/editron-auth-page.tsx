...
import { ChevronLeftIcon, GithubIcon, Chrome } from "lucide-react";
...
export function EditronAuthPage({
  onGoogleSignIn,
  onGithubSignIn,
}: EditronAuthPageProps) {
  return (
      ...
      <div className="bg-muted/60 relative hidden h-full flex-col border-r p-10 lg:flex">
        ...
        <div className="z-10 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-xl">
              &ldquo;Editron has revolutionized my development workflow. Code
              anywhere, anytime, with zero setup.&rdquo;
            </p>
        ...
        <div className="mx-auto space-y-6 sm:w-sm">
          ...
          <div className="flex flex-col space-y-3">
            <h1 className="font-heading text-3xl md:text-4xl font-black tracking-tight">
              Welcome to{" "}
              <span className="inline-flex overflow-visible bg-clip-text text-transparent bg-gradient-to-r from-red-500 via-rose-500 to-amber-500">
                Editron
              </span>
            </h1>
