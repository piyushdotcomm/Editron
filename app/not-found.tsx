...
export default function NotFound() {
  return (
    <div className="relative min-h-screen bg-background selection:bg-primary/20 overflow-x-hidden font-sans flex items-center justify-center px-4 py-12">
      ...
      <Card className="w-full max-w-lg text-center shadow-2xl border-border/60 bg-background/60 backdrop-blur-xl">
