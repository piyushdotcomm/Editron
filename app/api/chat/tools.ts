...
/**
 * Export schemas separately so tests can use native Zod methods
 * like safeParse() without depending on AI SDK FlexibleSchema.
 */
 ...
 * Each tool includes a Zod input schema to validate parameters.
 */
export const tools = {
    ...
    edit_multiple_files: createTool({
        description:
            "Create or replace the content of MULTIPLE files at once.",
        inputSchema: editMultipleFilesSchema,
    }),
